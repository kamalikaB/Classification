...
# #rulelist = get_rule_list('./best_cycles_9.txt')
...
#   print(acc_ca)
  ...
  print(f"Accuracy_Enc_CA: {acc_ca:.4f}")
  print(f"Precision_Enc_CA: {prec_ca:.4f}")
  print(f"Recall_Enc_CA: {rec_ca:.4f}")
  print(f"F1 Score_Enc_CA: {f1_ca:.4f}")
      # Calculate mean accuracy and standard deviation
  #print(accuracies_ca)
  #mean_accuracy = np.mean(accuracies_ca)
  #std_dev = np.std(accuracies_ca)
