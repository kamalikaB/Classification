...
from sklearn.metrics import accuracy_score
import numpy as np
# CA=[['0', '0', '0', '0', '0', '9', '0', '2']] #n=5 Breastcancer
# CA=[['0', '0', '0', '0', '5', '7', '8', '3']] #n=5 HaberMan
...
for ca in range(0,len(CA)):
  ...
  with open("./results/monks-2-new_5", "a") as file:
...
for ca in range(0,len(CA)):
  ...
  #for i in range(n_repeats):
      #X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.2, random_state=i)
  train_data_configuration, train_data_class,X_test,y_test=traintestsplit(df,random_split)
  y_pred_CA_np_array=CA_classification(CA[ca], train_data_configuration, train_data_class,X_test)
  from sklearn.metrics import accuracy_score
  import numpy as np
    ...
    # Calculate accuracy for each fold and append to the list
  ca_acc = accuracy_score(y_test, y_pred_CA_np_array)
  print(ca_acc)
      #accuracies_ca.append(acc)
...
#   print(result_ca)
  #print(accuracies_ca)
  # Write the result to a file (append mode, so results won't be overwritten)
#   with open("./results/Ann-Thyroid_5", "a") as file:
...
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.2, random_state=random_split)
