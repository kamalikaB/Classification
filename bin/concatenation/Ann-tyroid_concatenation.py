...
df = pd.read_csv('./data/Ann-Thyroid.csv')
...
class Preprocessor:
    ...
    def preprocess_training_data(self, X_train, y_train):
        ...
        X_train['A1'] = (X_train['A1'] * 100).astype(int)
        X_train['A1'] = X_train['A1'].astype(str).apply(lambda x: x.zfill(3))

        # X_train['A2'] = (X_train['A2'] * 10).astype(int)
        # X_train['A2'] = X_train['A2'].astype(str).apply(lambda x: x.zfill(3))

        # X_train['A3'] = (X_train['A3'] * 1).astype(int)
        # X_train['A3'] = X_train['A3'].astype(str).apply(lambda x: x.zfill(3))

        # X_train['A4'] = (X_train['A4'] * 1).astype(int)
        # X_train['A4'] = X_train['A4'].astype(str).apply(lambda x: x.zfill(4))

        # X_train['A5'] = (X_train['A5'] * 1000).astype(int)
        # X_train['A5'] = X_train['A5'].astype(str).apply(lambda x: x.zfill(3))

        # X_train['A6'] = (X_train['A6'] * 1000).astype(int)
        # X_train['A6'] = X_train['A6'].astype(str).apply(lambda x: x.zfill(3))

        # X_train['A7'] = (X_train['A7'] * 1000).astype(int)
        # X_train['A7'] = X_train['A7'].astype(str).apply(lambda x: x.zfill(3))

        # X_train['A8'] = (X_train['A8'] * 1000).astype(int)
        # X_train['A8'] = X_train['A8'].astype(str).apply(lambda x: x.zfill(3))

        # X_train['A9'] = (X_train['A9'] * 10000).astype(int)
        # X_train['A9'] = X_train['A9'].astype(str).apply(lambda x: x.zfill(4))
        
        # X_train['A10'] = (X_train['A10'] * 1000).astype(int)
        ...
        # X_train['A13'] = (X_train['A13'] * 100).astype(int)
    ...
    def preprocess_test_data(self, X_test, y_test):
        ...
        X_test['A1'] = (X_test['A1'] * 100).astype(int)
...
for ca in range(0,len(CA)):
  ...
  with open("./results/Ann_tyroid.txt", "a") as file:
