...
class Preprocessor:
    ...
    def preprocess_training_data(self, X_train, y_train):
        ...
        X_train['A1'] = X_train['A1'].astype(str).apply(lambda x: x.zfill(4))
        

      
        X_train['A2'] = (X_train['A2'] * 100).astype(int)
        X_train['A2'] = X_train['A2'].astype(str).apply(lambda x: x.zfill(3))


  
        X_train['A3'] = (X_train['A3'] * 100).astype(int)
        X_train['A3'] = X_train['A3'].astype(str).apply(lambda x: x.zfill(3))
        
        
  
        X_train['A4'] = (X_train['A4'] * 10).astype(int)
        X_train['A4'] = X_train['A4'].astype(str).apply(lambda x: x.zfill(3))
        ...
        X_train['A6'] = (X_train['A6'] * 100).astype(int)
    ...
    def preprocess_test_data(self, X_test, y_test):
        ...
        X_test['A1'] = X_test['A1'].astype(str).apply(lambda x: x.zfill(4))
        

      
        X_test['A2'] = (X_test['A2'] * 100).astype(int)
        X_test['A2'] = X_test['A2'].astype(str).apply(lambda x: x.zfill(3))


  
        X_test['A3'] = (X_test['A3'] * 100).astype(int)
        X_test['A3'] = X_test['A3'].astype(str).apply(lambda x: x.zfill(3))
        
        
  
        X_test['A4'] = (X_test['A4'] * 10).astype(int)
        X_test['A4'] = X_test['A4'].astype(str).apply(lambda x: x.zfill(3))
        ...
        X_test['A6'] = (X_test['A6'] * 100).astype(int)
...
for ca in range(0,len(CA)):
  ...
  with open("./results/Wine.txt", "a") as file:
