...
class Preprocessor:
    ...
    def preprocess_training_data(self, X_train, y_train):
        ...
        #print(X_train)
        X_train['A1'] = (X_train['A1'] * 1).astype(int)
        X_train['A1'] = X_train['A1'].astype(str).apply(lambda x: x.zfill(1))

        X_train['A2'] = (X_train['A2'] * 1).astype(int)
        X_train['A2'] = X_train['A2'].astype(str).apply(lambda x: x.zfill(1))

        X_train['A3'] = (X_train['A3'] * 100000).astype(int)
        X_train['A3'] = X_train['A3'].astype(str).apply(lambda x: x.zfill(6))

        X_train['A4'] = (X_train['A4'] * 100000).astype(int)
        X_train['A4'] = X_train['A4'].astype(str).apply(lambda x: x.zfill(6))

        X_train['A5'] = (X_train['A5'] * 100000).astype(int)
        X_train['A5'] = X_train['A5'].astype(str).apply(lambda x: x.zfill(6))

        X_train['A6'] = (X_train['A6'] * 100000).astype(int)
        X_train['A6'] = X_train['A6'].astype(str).apply(lambda x: x.zfill(6))

        X_train['A7'] = (X_train['A7'] * 100000).astype(int)
        X_train['A7'] = X_train['A7'].astype(str).apply(lambda x: x.zfill(6))

        X_train['A8'] = (X_train['A8'] * 100000).astype(int)
        X_train['A8'] = X_train['A8'].astype(str).apply(lambda x: x.zfill(6))

        X_train['A9'] = (X_train['A9'] * 100000).astype(int)
        X_train['A9'] = X_train['A9'].astype(str).apply(lambda x: x.zfill(6))
        
        X_train['A10'] = (X_train['A10'] * 100000).astype(int)
        X_train['A10'] = X_train['A10'].astype(str).apply(lambda x: x.zfill(6))

        X_train['A11'] = (X_train['A11'] * 100000).astype(int)
        X_train['A11'] = X_train['A11'].astype(str).apply(lambda x: x.zfill(6))

        X_train['A12'] = (X_train['A12'] * 100000).astype(int)
        X_train['A12'] = X_train['A12'].astype(str).apply(lambda x: x.zfill(6))

        X_train['A13'] = (X_train['A13'] * 100000).astype(int)
        X_train['A13'] = X_train['A13'].astype(str).apply(lambda x: x.zfill(6))

        
        X_train['A14'] = (X_train['A14'] * 100000).astype(int)
        X_train['A14'] = X_train['A14'].astype(str).apply(lambda x: x.zfill(6))

        
        
        X_train['A15'] = (X_train['A15'] * 100000).astype(int)
        X_train['A15'] = X_train['A15'].astype(str).apply(lambda x: x.zfill(6))
        


        
        X_train['A16'] = (X_train['A16'] *100000).astype(int)
        X_train['A16'] = X_train['A16'].astype(str).apply(lambda x: x.zfill(6))


       
        X_train['A17'] = (X_train['A17'] * 100000).astype(int)
        X_train['A17'] = X_train['A17'].astype(str).apply(lambda x: x.zfill(6))
   

       
        X_train['A18'] = (X_train['A18'] * 100000).astype(int)
        X_train['A18'] = X_train['A18'].astype(str).apply(lambda x: x.zfill(6))
        

       
        X_train['A19'] = (X_train['A19'] * 100000).astype(int)
        X_train['A19'] = X_train['A19'].astype(str).apply(lambda x: x.zfill(6))
        

     
        X_train['A20'] = (X_train['A20'] * 100000).astype(int)
        X_train['A20'] = X_train['A20'].astype(str).apply(lambda x: x.zfill(6))


      
        X_train['A21'] = (X_train['A21'] * 100000).astype(int)
        X_train['A21'] = X_train['A21'].astype(str).apply(lambda x: x.zfill(6))
        

        
        X_train['A22'] = (X_train['A22'] * 100000).astype(int)
        X_train['A22'] = X_train['A22'].astype(str).apply(lambda x: x.zfill(6))



        X_train['A23'] = (X_train['A23'] *100000).astype(int)
        X_train['A23'] = X_train['A23'].astype(str).apply(lambda x: x.zfill(6))


        
      
        X_train['A24'] = (X_train['A24'] * 100000).astype(int)
        X_train['A24'] = X_train['A24'].astype(str).apply(lambda x: x.zfill(6))
     


   
        X_train['A25'] = (X_train['A25'] * 100000).astype(int)
        X_train['A25'] = X_train['A25'].astype(str).apply(lambda x: x.zfill(6))


      
        X_train['A26'] = (X_train['A26'] * 100000).astype(int)
        X_train['A26'] = X_train['A26'].astype(str).apply(lambda x: x.zfill(6))
      

      
        X_train['A27'] = (X_train['A27'] * 100000).astype(int)
        X_train['A27'] = X_train['A27'].astype(str).apply(lambda x: x.zfill(6))


     
        X_train['A28'] = (X_train['A28'] * 100000).astype(int)
        X_train['A28'] = X_train['A28'].astype(str).apply(lambda x: x.zfill(6))
   

        X_train['A29'] = (X_train['A29'] * 100000).astype(int)
        X_train['A29'] = X_train['A29'].astype(str).apply(lambda x: x.zfill(6))


        X_train['A30'] = (X_train['A30'] * 100000).astype(int)
        X_train['A30'] = X_train['A30'].astype(str).apply(lambda x: x.zfill(6))



        X_train['A31'] = (X_train['A31'] * 100000).astype(int)
        X_train['A31'] = X_train['A31'].astype(str).apply(lambda x: x.zfill(6))



        X_train['A32'] = (X_train['A32'] * 100000).astype(int)
        X_train['A32'] = X_train['A32'].astype(str).apply(lambda x: x.zfill(6))


        X_train['A33'] = (X_train['A33'] * 100000).astype(int)
        X_train['A33'] = X_train['A33'].astype(str).apply(lambda x: x.zfill(6)) 


        X_train['A34'] = (X_train['A34'] * 100000).astype(int)
        X_train['A34'] = X_train['A34'].astype(str).apply(lambda x: x.zfill(6))
        ...
        # Replace NaN values with 0 (optional, if needed)
    ...
    def preprocess_test_data(self, X_test, y_test):
        ...
        # Encode target column
        X_test['A1'] = (X_test['A1'] * 1).astype(int)
        X_test['A1'] = X_test['A1'].astype(str).apply(lambda x: x.zfill(1))

        X_test['A2'] = (X_test['A2'] * 1).astype(int)
        X_test['A2'] = X_test['A2'].astype(str).apply(lambda x: x.zfill(1))

        X_test['A3'] = (X_test['A3'] * 100000).astype(int)
        X_test['A3'] = X_test['A3'].astype(str).apply(lambda x: x.zfill(6))

        X_test['A4'] = (X_test['A4'] * 100000).astype(int)
        X_test['A4'] = X_test['A4'].astype(str).apply(lambda x: x.zfill(6))

        X_test['A5'] = (X_test['A5'] * 100000).astype(int)
        X_test['A5'] = X_test['A5'].astype(str).apply(lambda x: x.zfill(6))

        X_test['A6'] = (X_test['A6'] * 100000).astype(int)
        X_test['A6'] = X_test['A6'].astype(str).apply(lambda x: x.zfill(6))

        X_test['A7'] = (X_test['A7'] * 100000).astype(int)
        X_test['A7'] = X_test['A7'].astype(str).apply(lambda x: x.zfill(6))

        X_test['A8'] = (X_test['A8'] * 100000).astype(int)
        X_test['A8'] = X_test['A8'].astype(str).apply(lambda x: x.zfill(6))

        X_test['A9'] = (X_test['A9'] * 100000).astype(int)
        X_test['A9'] = X_test['A9'].astype(str).apply(lambda x: x.zfill(6))
        
        X_test['A10'] = (X_test['A10'] * 100000).astype(int)
        X_test['A10'] = X_test['A10'].astype(str).apply(lambda x: x.zfill(6))

        X_test['A11'] = (X_test['A11'] * 100000).astype(int)
        X_test['A11'] = X_test['A11'].astype(str).apply(lambda x: x.zfill(6))

        X_test['A12'] = (X_test['A12'] * 100000).astype(int)
        X_test['A12'] = X_test['A12'].astype(str).apply(lambda x: x.zfill(6))

        X_test['A13'] = (X_test['A13'] * 100000).astype(int)
        X_test['A13'] = X_test['A13'].astype(str).apply(lambda x: x.zfill(6))

        
        X_test['A14'] = (X_test['A14'] * 100000).astype(int)
        X_test['A14'] = X_test['A14'].astype(str).apply(lambda x: x.zfill(6))

        
        
        X_test['A15'] = (X_test['A15'] * 100000).astype(int)
        X_test['A15'] = X_test['A15'].astype(str).apply(lambda x: x.zfill(6))
        


        
        X_test['A16'] = (X_test['A16'] *100000).astype(int)
        X_test['A16'] = X_test['A16'].astype(str).apply(lambda x: x.zfill(6))


       
        X_test['A17'] = (X_test['A17'] * 100000).astype(int)
        X_test['A17'] = X_test['A17'].astype(str).apply(lambda x: x.zfill(6))
   

       
        X_test['A18'] = (X_test['A18'] * 100000).astype(int)
        X_test['A18'] = X_test['A18'].astype(str).apply(lambda x: x.zfill(6))
        

       
        X_test['A19'] = (X_test['A19'] * 100000).astype(int)
        X_test['A19'] = X_test['A19'].astype(str).apply(lambda x: x.zfill(6))
        

     
        X_test['A20'] = (X_test['A20'] * 100000).astype(int)
        X_test['A20'] = X_test['A20'].astype(str).apply(lambda x: x.zfill(6))


      
        X_test['A21'] = (X_test['A21'] * 100000).astype(int)
        X_test['A21'] = X_test['A21'].astype(str).apply(lambda x: x.zfill(6))
        

        
        X_test['A22'] = (X_test['A22'] * 100000).astype(int)
        X_test['A22'] = X_test['A22'].astype(str).apply(lambda x: x.zfill(6))



        X_test['A23'] = (X_test['A23'] *100000).astype(int)
        X_test['A23'] = X_test['A23'].astype(str).apply(lambda x: x.zfill(6))


        
      
        X_test['A24'] = (X_test['A24'] * 100000).astype(int)
        X_test['A24'] = X_test['A24'].astype(str).apply(lambda x: x.zfill(6))
     


   
        X_test['A25'] = (X_test['A25'] * 100000).astype(int)
        X_test['A25'] = X_test['A25'].astype(str).apply(lambda x: x.zfill(6))


      
        X_test['A26'] = (X_test['A26'] * 100000).astype(int)
        X_test['A26'] = X_test['A26'].astype(str).apply(lambda x: x.zfill(6))
      

      
        X_test['A27'] = (X_test['A27'] * 100000).astype(int)
        X_test['A27'] = X_test['A27'].astype(str).apply(lambda x: x.zfill(6))


     
        X_test['A28'] = (X_test['A28'] * 100000).astype(int)
        X_test['A28'] = X_test['A28'].astype(str).apply(lambda x: x.zfill(6))
   

        X_test['A29'] = (X_test['A29'] * 100000).astype(int)
        X_test['A29'] = X_test['A29'].astype(str).apply(lambda x: x.zfill(6))


        X_test['A30'] = (X_test['A30'] * 100000).astype(int)
        X_test['A30'] = X_test['A30'].astype(str).apply(lambda x: x.zfill(6))



        X_test['A31'] = (X_test['A31'] * 100000).astype(int)
        X_test['A31'] = X_test['A31'].astype(str).apply(lambda x: x.zfill(6))



        X_test['A32'] = (X_test['A32'] * 100000).astype(int)
        X_test['A32'] = X_test['A32'].astype(str).apply(lambda x: x.zfill(6))


        X_test['A33'] = (X_test['A33'] * 100000).astype(int)
        X_test['A33'] = X_test['A33'].astype(str).apply(lambda x: x.zfill(6)) 


        X_test['A34'] = (X_test['A34'] * 100000).astype(int)
        X_test['A34'] = X_test['A34'].astype(str).apply(lambda x: x.zfill(6))
...
rulelist = get_rule_list('./large_datarules_29.txt')
