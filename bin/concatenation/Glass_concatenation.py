...
class Preprocessor:
    ...
    def preprocess_training_data(self, X_train, y_train):
        ...
        X_train['A2'] = (X_train['A2'] * 100000).astype(int)
        ...
        X_train['A4'] = (X_train['A4'] * 100).astype(int)
        X_train['A4'] = X_train['A4'].astype(str).apply(lambda x: x.zfill(3))
        

        
        X_train['A5'] = (X_train['A5'] * 100).astype(int)
    ...
    def preprocess_test_data(self, X_test, y_test):
        ...
        X_test['A2'] = (X_test['A2'] * 100000).astype(int)
        ...
        X_test['A4'] = (X_test['A4'] * 100).astype(int)
        X_test['A4'] = X_test['A4'].astype(str).apply(lambda x: x.zfill(3))
        

        
        X_test['A5'] = (X_test['A5'] * 100).astype(int)
...
for ca in range(0,len(CA)):
  ...
  with open("./results/glass.txt", "a") as file:
