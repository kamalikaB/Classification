...
df = pd.read_csv('./data/monks-3-new.csv')
...
class Preprocessor:
    ...
    def preprocess_training_data(self, X_train, y_train):
        ...
        X_train['A3'] = (X_train['A3'] * 1).astype(int)
        X_train['A3'] = X_train['A3'].astype(str).apply(lambda x: x.zfill(1))
        
        
  
        X_train['A4'] = (X_train['A4'] * 1).astype(int)
        X_train['A4'] = X_train['A4'].astype(str).apply(lambda x: x.zfill(1))
        

        
        X_train['A5'] = (X_train['A5'] * 1).astype(int)
        X_train['A5'] = X_train['A5'].astype(str).apply(lambda x: x.zfill(1))
 

      
        X_train['A6'] = (X_train['A6'] * 1).astype(int)
        X_train['A6'] = X_train['A6'].astype(str).apply(lambda x: x.zfill(1))
        
        
        # X_train['A7'] = (X_train['A7'] * 100).astype(int)
        # X_train['A7'] = X_train['A7'].astype(str).apply(lambda x: x.zfill(3))
    ...
    def preprocess_test_data(self, X_test, y_test):
        ...
        X_test['A3'] = X_test['A3'].astype(str).apply(lambda x: x.zfill(1))
        
        
  
        X_test['A4'] = (X_test['A4'] * 1).astype(int)
        X_test['A4'] = X_test['A4'].astype(str).apply(lambda x: x.zfill(1))
        

        
        X_test['A5'] = (X_test['A5'] * 1).astype(int)
        X_test['A5'] = X_test['A5'].astype(str).apply(lambda x: x.zfill(1))
 

      
        X_test['A6'] = (X_test['A6'] * 1).astype(int)
        X_test['A6'] = X_test['A6'].astype(str).apply(lambda x: x.zfill(1))

        
        # X_test['A7'] = (X_test['A7'] * 100).astype(int)
        ...
        # X_test['A8'] = (X_test['A8'] * 100).astype(int)
        # X_test['A8'] = X_test['A8'].astype(str).apply(lambda x: x.zfill(2))
     

        
        # X_test['A9'] = (X_test['A9'] * 100).astype(int)
        # X_test['A9'] = X_test['A9'].astype(str).apply(lambda x: x.zfill(3))
        

        
        # X_test['A10'] = (X_test['A10'] * 100).astype(int)
        ...
        # X_test['A13'] = (X_test['A13'] * 1).astype(int)
...
rulelist = get_rule_list('/home/baby/Classification_NCJ (Copy 2)/small_datarules_52.txt')
...
for ca in range(0,len(CA)):
  ...
  with open("./results/Monk3_5.txt", "a") as file:
