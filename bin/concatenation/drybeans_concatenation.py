...
class Preprocessor:
    ...
    def preprocess_training_data(self, X_train, y_train):
        ...
        X_train['A1'] = X_train['A1'].astype(str).apply(lambda x: x.zfill(5))

        X_train['A2'] = (X_train['A2'] * 1000).astype(int)
        X_train['A2'] = X_train['A2'].astype(str).apply(lambda x: x.zfill(6))

        X_train['A3'] = (X_train['A3'] * 1000).astype(int)
        X_train['A3'] = X_train['A3'].astype(str).apply(lambda x: x.zfill(6))

        X_train['A4'] = (X_train['A4'] * 1000).astype(int)
        X_train['A4'] = X_train['A4'].astype(str).apply(lambda x: x.zfill(6))

        X_train['A5'] = (X_train['A5'] * 1000).astype(int)
        X_train['A5'] = X_train['A5'].astype(str).apply(lambda x: x.zfill(6))

        X_train['A6'] = (X_train['A6'] * 1000).astype(int)
        X_train['A6'] = X_train['A6'].astype(str).apply(lambda x: x.zfill(6))

        X_train['A7'] = (X_train['A7'] * 1).astype(int)
        X_train['A7'] = X_train['A7'].astype(str).apply(lambda x: x.zfill(5))

        X_train['A8'] = (X_train['A8'] * 1000).astype(int)
        X_train['A8'] = X_train['A8'].astype(str).apply(lambda x: x.zfill(6))

        X_train['A9'] = (X_train['A9'] * 10000).astype(int)
        X_train['A9'] = X_train['A9'].astype(str).apply(lambda x: x.zfill(4))
        
        X_train['A10'] = (X_train['A10'] * 10000).astype(int)
        X_train['A10'] = X_train['A10'].astype(str).apply(lambda x: x.zfill(4))

        X_train['A11'] = (X_train['A11'] * 10000).astype(int)
        X_train['A11'] = X_train['A11'].astype(str).apply(lambda x: x.zfill(4))

        X_train['A12'] = (X_train['A12'] * 10000).astype(int)
        X_train['A12'] = X_train['A12'].astype(str).apply(lambda x: x.zfill(4))

        X_train['A13'] = (X_train['A13'] * 10000).astype(int)
        X_train['A13'] = X_train['A13'].astype(str).apply(lambda x: x.zfill(4))

        
        X_train['A14'] = (X_train['A14'] * 10000).astype(int)
        X_train['A14'] = X_train['A14'].astype(str).apply(lambda x: x.zfill(4))

        
        
        X_train['A15'] = (X_train['A15'] * 10000).astype(int)
        X_train['A15'] = X_train['A15'].astype(str).apply(lambda x: x.zfill(4))
    ...
    def preprocess_test_data(self, X_test, y_test):
        ...
        X_test['A1'] = X_test['A1'].astype(str).apply(lambda x: x.zfill(5))

        X_test['A2'] = (X_test['A2'] * 1000).astype(int)
        X_test['A2'] = X_test['A2'].astype(str).apply(lambda x: x.zfill(6))

        X_test['A3'] = (X_test['A3'] * 1000).astype(int)
        X_test['A3'] = X_test['A3'].astype(str).apply(lambda x: x.zfill(6))

        X_test['A4'] = (X_test['A4'] * 1000).astype(int)
        ...
        X_test['A7'] = (X_test['A7'] * 1).astype(int)
        X_test['A7'] = X_test['A7'].astype(str).apply(lambda x: x.zfill(5))
        ...
        X_test['A10'] = (X_test['A10'] * 10000).astype(int)
        X_test['A10'] = X_test['A10'].astype(str).apply(lambda x: x.zfill(4))

        X_test['A11'] = (X_test['A11'] * 10000).astype(int)
        X_test['A11'] = X_test['A11'].astype(str).apply(lambda x: x.zfill(4))

        X_test['A12'] = (X_test['A12'] * 10000).astype(int)
        X_test['A12'] = X_test['A12'].astype(str).apply(lambda x: x.zfill(4))

        X_test['A13'] = (X_test['A13'] * 10000).astype(int)
        X_test['A13'] = X_test['A13'].astype(str).apply(lambda x: x.zfill(4))

        
        X_test['A14'] = (X_test['A14'] * 10000).astype(int)
        X_test['A14'] = X_test['A14'].astype(str).apply(lambda x: x.zfill(4))

        
        
        X_test['A15'] = (X_test['A15'] * 10000).astype(int)
        X_test['A15'] = X_test['A15'].astype(str).apply(lambda x: x.zfill(4))
...
for ca in range(0,len(CA)):
  ...
  with open("./results/drybean_4.txt", "a") as file:
